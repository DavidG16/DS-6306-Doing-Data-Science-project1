...
B = ggplot(map.df, aes(x=long, y=lat, group=group))+
  geom_polygon(aes(group=group, fill=Num.of.Breweries))+ geom_path()+
   geom_text(data=map.df,aes(label = Num.of.Breweries))+
