...
```
Top 5 states in terms of beer consumption are California, Texas, Florida, New York and Pennsylvania. refer to the report published at https://vinepair.com/articles/map-states-drink-beer-america-2020/
...
beers_state_top_5
# Step 2-  Find # of beers that are ale or ipa per state
...
# Step 3 - Find the states that have the lowest number of ales 

# Step 4 - Find states that have have enough breweries and not enough ale beers, make recommendation of  
# to launch a ale style beer in this state
# We choose Texas, its number 2 in consumption and population is growing 
