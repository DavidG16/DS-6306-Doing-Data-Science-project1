...
```
This heat-map helps to easily identify which states are the ones with the most breweries. 
...
The Accuracy, specificity and sensitivity measures are quite high for K=5. Accuracy is at 90%.
